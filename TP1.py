...
class CandleStick(Graph):
    def __init__(self,company,width,height):
        ...
        self.open = quandl.get('WIKI/'+self.company,column_index=1,rows=5)
        self.high = quandl.get('WIKI/'+self.company,column_index=2,rows=5)
        self.low = quandl.get('WIKI/'+self.company,column_index=3,rows=5)
        self.convertOpen = []
        self.convertHigh = []
        self.convertLow = []
        self.convertClose = []
